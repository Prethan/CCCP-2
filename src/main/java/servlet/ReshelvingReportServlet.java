...
import report.ReshelvingReport;
import repository.*;
...
@WebServlet("/reshelvingReport")
public class ReshelvingReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ReshelvingReport itemsBelowThreshold = reportService.generateReshelvingReport();

        request.setAttribute("itemsBelowThreshold", itemsBelowThreshold);

        RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/views/reshelvingReport.jsp");
